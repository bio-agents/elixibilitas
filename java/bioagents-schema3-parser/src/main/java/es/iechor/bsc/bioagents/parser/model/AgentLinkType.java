...
public enum AgentLinkType {
    ...
    @XmlEnumValue("Scientific benchmark") SCIENTIFIC_BENCHMARK("Scientific benchmark"),
    @XmlEnumValue("Technical monitoring") TECHNICAL_MONITORING("Technical monitoring");
