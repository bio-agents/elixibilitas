...
public enum DownloadType {
    ...
    @XmlEnumValue("Agent wrapper (galaxy)") GALAXY_TOOL_WRAPPER("Agent wrapper (galaxy)"),
    @XmlEnumValue("Agent wrapper (taverna)") TAVERNA_TOOL_WRAPPER("Agent wrapper (taverna)"),
    @XmlEnumValue("Agent wrapper (other)") OTHER_TOOL_WRAPPER("Agent wrapper (other)"),
