...
@XmlType(name = "", propOrder = {"bioagentsId",
                                 "type"})
public class Relation {

    private String bioagentsId;
    ...
    public void setBioagentsId(String bioagentsId) {
        this.bioagentsId = bioagentsId;
    }

    @XmlElement(required = true)
    public SoftwareRelationType getType() {
        return type;
    }

    public void setType(SoftwareRelationType type) {
        this.type = type;
    }
}
