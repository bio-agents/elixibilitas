...
public enum iEchorPlatform {
    @XmlEnumValue("Data") DATA("Data"),
    @XmlEnumValue("Agents") TOOLS("Agents"),
    ...
    private iEchorPlatform(String value) {
        this.value = value;
    }
    ...
    public static iEchorPlatform fromValue(String value) {
        for (iEchorPlatform type: iEchorPlatform.values()) {
