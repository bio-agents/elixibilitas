...
public class AgentsComparator {
    
    private final static int[][] matrix = matrix(1000, 1000);
        
    public static double compare(Agent t1, Agent t2) {
    ...
    private static double cmpSources(Agent t1, Agent t2) {
    ...
    private static double cmpBinaries(Agent t1, Agent t2) {
    ...
    private static double cmpHomepages(Agent t1, Agent t2) {
        final Web web1 = t1.getWeb();
        final Web web2 = t2.getWeb();

        if (web1 == null || web2 == null) {
            return 0;
        }
        
        final URI home1 = web1.getHomepage();
        final URI home2 = web2.getHomepage();
    ...
    private static double cmpNames(Agent t1, Agent t2) {
    ...
    private static double cmpDescriptions(Agent t1, Agent t2) {
