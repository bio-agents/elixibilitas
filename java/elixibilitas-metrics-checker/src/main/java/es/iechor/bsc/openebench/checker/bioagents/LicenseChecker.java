...
import es.bsc.inb.iechor.openebench.model.metrics.License;
...
public class LicenseChecker implements MetricsChecker {
    ...
    private static License check(Agent agent) {
        final String lic = agent.getLicense();
