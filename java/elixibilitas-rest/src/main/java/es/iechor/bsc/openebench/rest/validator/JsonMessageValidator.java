...
package es.iechor.bsc.openebench.rest.validator;

import es.iechor.bsc.json.schema.JsonSchemaException;
import es.iechor.bsc.json.schema.JsonSchemaReader;
import es.iechor.bsc.json.schema.ValidationError;
...
public class JsonMessageValidator implements ConstraintValidator<JsonSchema, String> {
    ...
    private es.iechor.bsc.json.schema.model.JsonSchema schema;
