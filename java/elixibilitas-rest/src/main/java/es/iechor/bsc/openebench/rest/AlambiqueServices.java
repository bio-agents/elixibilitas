...
import es.iechor.bsc.elixibilitas.dao.AlambiqueDAO;
...
public class AlambiqueServices {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(
        summary = "Returns documents by the unprefixed agent's id.",
        responses = {
            @ApiResponse(content = @Content(mediaType = MediaType.APPLICATION_JSON),
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Operation(
        summary = "Returns a document by the agent's id.",
        responses = {
            @ApiResponse(content = @Content(mediaType = MediaType.APPLICATION_JSON),
    ...
    @Operation(
        ...
        description = "Accepts an array of JSON documents with defined @id " +
                      "(i.e. 'https://openebench.bsc.es/monitor/alambique/bioagents:pmut:2017/web/mmb.irbbarcelona.org'). " +
